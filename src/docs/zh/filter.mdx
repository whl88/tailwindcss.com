...
export const description = "用于给元素添加滤镜的工具类。";
...
使用 `blur-xs`、`grayscale` 等工具类，给元素应用滤镜：
...
你可以组合使用以下滤镜工具类：[blur](/docs/filter-blur)、[brightness](/docs/filter-brightness)、[contrast](/docs/filter-contrast)、[drop-shadow](/docs/filter-drop-shadow)、[grayscale](/docs/filter-grayscale)、[hue-rotate](/docs/filter-hue-rotate)、[invert](/docs/filter-invert)、[saturate](/docs/filter-saturate)、[sepia](/docs/filter-sepia)。

### 移除滤镜

使用 `filter-none` 工具类，移除元素上所有的滤镜：
