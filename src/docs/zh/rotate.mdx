...
使用 `rotate-45`、`rotate-90` 等 `rotate-<number>` 工具类，按角度旋转元素：
...
使用 `-rotate-45`、`-rotate-90` 等 `-rotate-<number>` 工具类，按角度逆时针旋转元素：
...
组合使用 `rotate-x-50`、`-rotate-y-30`、`rotate-z-45` 等 `rotate-x-<number>`、`rotate-y-<number>`、`rotate-z-<number>` 工具类，让元素在 3D 空间中旋转：
