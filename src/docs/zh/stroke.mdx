...
export const description = "用于设置 SVG 元素描边的工具类。";
...
使用 `stroke-indigo-500`、`stroke-lime-600` 等工具类，修改 SVG 的描边颜色：
...
这适合给 [Heroicons](https://heroicons.com) 这类图标集统一上色。

### 使用当前颜色

使用 `stroke-current` 工具类，把描边颜色设为当前文本颜色：
