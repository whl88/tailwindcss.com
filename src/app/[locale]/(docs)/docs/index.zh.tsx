export default {
  ...
  核心概念: [
    ["使用工具类编写样式", "/docs/styling-with-utility-classes"],
    ["悬停、聚焦与其他状态", "/docs/hover-focus-and-other-states"],
    ["响应式设计", "/docs/responsive-design"],
    ["深色模式", "/docs/dark-mode"],
    ["主题变量", "/docs/theme"],
    ["颜色", "/docs/colors"],
    ["添加自定义样式", "/docs/adding-custom-styles"],
    ["在源文件中检测类名", "/docs/detecting-classes-in-source-files"],
    ["函数与指令", "/docs/functions-and-directives"],
  ] as const,
  基础样式: [["Preflight", "/docs/preflight"]] as const,
  布局: [
  ...
  无障碍: [["forced-color-adjust", "/docs/forced-color-adjust"]] as const,
};
