...
const INSTALLATION_TAB_DEFS = [
  ["usingVite", "/docs/installation/using-vite"],
  ["usingPostcss", "/docs/installation/using-postcss"],
  ["tailwindCli", "/docs/installation/tailwind-cli"],
  ["frameworkGuides", "/docs/installation/framework-guides"],
  ["playCdn", "/docs/installation/play-cdn"],
...
export default async function Page({ children }: { children: React.ReactNode }) {
  const t = await getTranslations("InstallationTabs");
  return (
    <>
          ...
          <div className="mt-10" data-content="true">
            <section className="relative mb-16">
              <div className="relative z-10">
                ...
                <TabBar
                  tabs={INSTALLATION_TAB_DEFS.map(([key, url]) => ({
                    title: t(`tabs.${key}`),
                    url,
                  }))}
                />
