...
function LocaleSwitcher() {
  ...
  return (
    <Link
      href={pathname}
      locale={otherLocale}
      className="rounded-full px-2 py-1 text-xs/5 font-medium text-gray-600 ring-1 ring-gray-950/10 hover:bg-gray-950/5 dark:text-gray-300 dark:ring-white/10 dark:hover:bg-white/10"
    >
      {otherLocale === "zh" ? t("zh") : t("en")}
    </Link>
  );
}
    ...
    <div className="bg-white dark:bg-gray-950">
      <div className="flex h-14 items-center justify-between gap-8 px-4 sm:px-6">
        ...
        <div className="flex items-center gap-6 max-md:hidden">
          ...
          <Link href="https://github.com/tailwindlabs/tailwindcss" aria-label={t("githubRepo")}>
            <GitHubLogo className="size-5 fill-black/40 dark:fill-gray-400" />
          </Link>
        </div>
        <div className="flex items-center gap-2.5 md:hidden">
          <SearchButton aria-label={t("search")} className="inline-grid size-7 place-items-center rounded-md">
          ...
          <IconButton aria-label={t("nav")} onClick={() => setNavIsOpen(!navIsOpen)}>
            <svg viewBox="0 0 16 16" fill="currentColor" className="size-4">
          ...
          >
            <DialogPanel className="size-full overflow-y-auto">
              <div className="flex h-14 items-center justify-between px-4 py-4 sm:px-6">
                ...
                <IconButton aria-label={t("nav")} onClick={() => setNavIsOpen(false)}>
                  <svg viewBox="0 0 16 16" fill="currentColor" className="size-4">
