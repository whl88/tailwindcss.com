...
export default async function BuildAnythingSection() {
  const t = await getTranslations("Home.buildAnything");
  return (
    <div className="relative max-w-full">
      ...
      <GridContainer className="2xl:before:hidden 2xl:after:hidden">
        <CategoryHeader className="text-fuchsia-500 dark:text-fuchsia-400">{t("category")}</CategoryHeader>
      </GridContainer>
