...
export default async function WhyTailwindCssSection() {
  ...
  return (
    <div className="relative max-w-full">
      ...
      <GridContainer className="2xl:before:hidden 2xl:after:hidden">
        <CategoryHeader className="text-pink-500 dark:text-pink-400">{t("category")}</CategoryHeader>
      </GridContainer>
        ...
        <div className="grid w-full grid-flow-dense grid-cols-30 gap-2 bg-gray-950/5 p-2 dark:bg-white/10">
          <BentoItem className="col-span-full">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("responsiveDesign.title")}</BentoTitle>
                <BentoDescription>{t("responsiveDesign.description")}</BentoDescription>
              </div>
            </BentoHeader>
                      ...
                      <div className="flex flex-1 flex-col">
                        <div className="relative mb-4 overflow-hidden rounded-lg @max-[theme(--breakpoint-xl)]:-mx-4 @max-[theme(--breakpoint-xl)]:-mt-4 @min-[theme(--breakpoint-lg)]:hidden">
                          ...
                          <div className="absolute inset-0 flex flex-col justify-end gap-2 bg-linear-to-b from-transparent via-transparent to-gray-950 p-6 @min-[theme(--breakpoint-sm)]:hidden">
                            <span className="text-sm/6 font-semibold text-white/80">{t("entireHouse")}</span>
                            <span className="text-xl/6 font-semibold text-white">{t("beachHouseTitle")}</span>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 @min-[theme(--breakpoint-sm)]:grid-cols-[1fr_auto] @min-[theme(--breakpoint-xl)]:grid-cols-1">
                          <div>
                            ...
                            <span className="mt-2 flex gap-2">
                              ...
                              <span className="text-sm/6 text-gray-500">{t("reviews", { count: 128 })}</span>
          ...
          <BentoItem className="col-span-full md:col-span-15">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("filters.title")}</BentoTitle>
                <BentoDescription>{t("filters.description")}</BentoDescription>
              </div>
            </BentoHeader>
          ...
          <BentoItem className="col-span-full md:col-span-15">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("darkMode.title")}</BentoTitle>
                <BentoDescription>
                  {t("darkMode.intro")}
          ...
          <BentoItem className="col-span-full md:col-span-15 xl:col-span-12">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("cssVariables.title")}</BentoTitle>
                <BentoDescription>{t("cssVariables.description")}</BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody className="h-112">
          ...
          <BentoItem className="col-span-full xl:col-span-18">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("p3Colors.title")}</BentoTitle>
                <BentoDescription>{t("p3Colors.description")}</BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody className="h-112">
              {(() => {
          ...
          <BentoItem className="col-span-full xl:col-span-15">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("cssGridLayout.title")}</BentoTitle>
                <BentoDescription>{t("cssGridLayout.description")}</BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody className="h-112">
              <div className="-mr-16 -mb-8 [--size:--spacing(48)] lg:flex lg:justify-center xl:block">
                <div className="-mt-18 sm:-mt-26">
                  <div className="bg-white p-6 ring ring-gray-950/5 sm:p-16 dark:bg-gray-950 dark:ring-white/10">
                    <h3 className="text-base/6 font-semibold text-gray-950 dark:text-white">{t("cssGridLayout.browseHeading")}</h3>
                    <div className="mt-6 grid grid-cols-[repeat(2,var(--size))] grid-rows-[repeat(3,var(--size))] gap-2 sm:grid-cols-[repeat(3,var(--size))] sm:grid-rows-[repeat(2,var(--size))]">
                      <div className="relative col-span-2 row-span-1 overflow-hidden rounded-t-2xl sm:col-span-1 sm:row-span-2 sm:rounded-none sm:rounded-l-2xl dark:outline dark:outline-white/10">
                        ...
                        <div className="absolute inset-0 flex items-end bg-linear-to-b from-transparent via-transparent to-gray-950">
                          <span className="p-4 text-sm/5 font-semibold text-white">{t("cssGridLayout.treehouses")}</span>
                        </div>
                      </div>
                      <div className="relative dark:outline dark:outline-white/10">
                        <img alt="" src={cssGrid2.src} />
                        <div className="absolute inset-0 flex items-end bg-linear-to-b from-transparent via-transparent to-gray-950">
                          <span className="p-4 text-sm/5 font-semibold text-white">{t("cssGridLayout.mansions")}</span>
                        </div>
                      </div>
                      <div className="relative overflow-hidden sm:rounded-tr-2xl dark:outline dark:outline-white/10">
                        <img alt="" src={cssGrid3.src} />
                        <div className="absolute inset-0 flex items-end bg-linear-to-b from-transparent via-transparent to-gray-950">
                          <span className="p-4 text-sm/5 font-semibold text-white">{t("cssGridLayout.lakefrontCottages")}</span>
                        </div>
                      </div>
                      <div className="relative col-span-2 overflow-hidden rounded-b-2xl sm:rounded-bl-none dark:outline dark:outline-white/10">
                        ...
                        <div className="absolute inset-0 flex items-end bg-linear-to-b from-transparent via-transparent to-gray-950">
                          <span className="p-4 text-sm/5 font-semibold text-white">{t("cssGridLayout.designerHomes")}</span>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <BentoItem className="col-span-full xl:col-span-15">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("transitions.title")}</BentoTitle>
                <BentoDescription>{t("transitions.description")}</BentoDescription>
              </div>
            </BentoHeader>
          ...
          <BentoItem className="col-span-full md:col-span-15 xl:col-span-10">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("cascadeLayers.title")}</BentoTitle>
                <BentoDescription>{t("cascadeLayers.description")}</BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody className="h-112">
              <div className="-mr-16 -mb-16">
          ...
          <BentoItem className="col-span-full md:col-span-15 xl:col-span-10">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("logicalProperties.title")}</BentoTitle>
                <BentoDescription>{t("logicalProperties.description")}</BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody padding={false} className="h-112">
              ...
              <div className="@container relative isolate flex h-full items-center justify-center">
                <div className="absolute bottom-12 -left-2 z-1 w-[60cqw] shrink-0 divide-y divide-gray-950/5 rounded-xl bg-white shadow-2xl inset-ring inset-ring-gray-950/5 dark:divide-white/5 dark:bg-gray-800 dark:inset-ring-white/5">
                  {[
                    { src: avatar4.src, name: t("logicalProperties.nameWill"), role: t("logicalProperties.roleWill") },
                    { src: avatar5.src, name: t("logicalProperties.nameKristin"), role: t("logicalProperties.roleKristin") },
                    {
                      src: avatar6.src,
                      name: t("logicalProperties.nameEmanual"),
                      role: t("logicalProperties.roleEmanual"),
                    },
                    { src: avatar7.src, name: t("logicalProperties.nameKiara"), role: t("logicalProperties.roleKiara") },
                  ].map((user, idx) => {
                    return (
          ...
          <BentoItem className="col-span-full md:col-span-15 xl:col-span-10">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("containerQueries.title")}</BentoTitle>
                <BentoDescription>{t("containerQueries.description")}</BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody className="h-112">
              <div className="-mr-16 -mb-16">
          ...
          <BentoItem className="col-span-full md:col-span-15">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("gradients.title")}</BentoTitle>
                <BentoDescription>{t("gradients.description")}</BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody className="h-112">
          ...
          <BentoItem className="col-span-full md:col-span-15">
            <BentoHeader>
              ...
              <div>
                <BentoTitle>{t("transforms3d.title")}</BentoTitle>
                <BentoDescription>{t("transforms3d.description")}</BentoDescription>
              </div>
            </BentoHeader>
            <BentoBody className="h-112">
              <Transforms3d />
